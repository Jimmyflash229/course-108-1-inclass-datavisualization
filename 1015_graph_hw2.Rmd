...
data0<-list(                                              #由於資料輸入格式皆錯誤，筆數不多情況下，改為手動輸入
  ...
  博士畢業=c(26006,12923,10026),                    
  碩士畢業=c(234770,178495,122321),              #資料來源:全國人口統計資料地圖
  大學畢業=c(715281,785388,526897),              #https://gis.ris.gov.tw/dashboard.html?key=B04
  專科畢業=c(277536,372940,249688),
  高中畢業=c(589833,1085587,798043),
  國中畢業=c(255419,668721,397877),
  國小畢業及以下=c(206070,401741,336689)
)
