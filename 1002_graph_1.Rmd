...
BigCityCost  %>%  group_by(
  地區
    ...
    食的消費=(sum(`食品餐飲類男性[金額，新台幣]`) +sum(`食品餐飲類女性[金額，新台幣]`))/402,
    衣的消費=(sum(`衣著飾品類男性[金額，新台幣]`)+sum(`衣著飾品類女性[金額，新台幣]`))/402    
...
test<-read_csv("http://www.nccc.com.tw/dataDownload/Gender/BANK_MCT_ALL_GD.CSV")
t
```
